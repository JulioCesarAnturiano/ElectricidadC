...
/// Permite registrar la lectura del medidor de un cliente y ver ubicación en mapa
...
class _ClienteDetailScreenState extends State<ClienteDetailScreen> {
  ...
  Future<void> _abrirEnGoogleMaps() async {
    final String direccion = Uri.encodeComponent(
      '${widget.cliente.direccion}, Bolivia'
    );
  ...
  /// Obtiene coordenadas simuladas basadas en el código del cliente
  LatLng _obtenerCoordenadas() {
    // Coordenadas base de Santa Cruz, Bolivia
    const double latBase = -17.7833;
    const double lngBase = -63.1821;
    
    // Generar desplazamiento basado en el código del cliente
    final String codigo = widget.cliente.codCliente;
    final int hash = codigo.hashCode;
    final double offsetLat = ((hash % 100) - 50) / 1000; // ±0.05 grados
    final double offsetLng = (((hash ~/ 100) % 100) - 50) / 1000;
    
    return LatLng(latBase + offsetLat, lngBase + offsetLng);
  }
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: const LinearGradient(
                    colors: [Color(0xFF0D3D1C), Color(0xFF145226)],
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  _mostrarMapa ? 'Ocultar mapa' : 'Ver ubicación en mapa',
                                  style: GoogleFonts.inter(
                          ...
                          Icon(
                            _mostrarMapa ? Icons.expand_less : Icons.expand_more,
                            color: Colors.white,
                            size: 28,
                          ),
                        ],
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FlutterMap(
                          options: MapOptions(
                            initialCenter: _obtenerCoordenadas(),
                            initialZoom: 15.0,
                          ),
                          children: [
                            TileLayer(
                              urlTemplate: 'https://tile.openstreetmap.org/{z}/{x}/{y}.png',
                              userAgentPackageName: 'com.cooperativa.electricidad',
                            ),
                            MarkerLayer(
                              markers: [
                                Marker(
                                  point: _obtenerCoordenadas(),
                                  width: 80,
                                  height: 80,
                                  child: const Icon(
                                    Icons.location_pin,
                      ...
                      Container(
                        ...
                        child: TextButton.icon(
                          ...
                          icon: const Icon(Icons.directions, color: Color(0xFFF0E000)),
                          label: Text(
      ...
      child: Row(
        children: [
          Icon(
            icono,
            size: 20,
            color: destacado ? const Color(0xFF1B6B2F) : Colors.grey[600],
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  valor,
                  style: TextStyle(
                    color: destacado ? const Color(0xFF1B6B2F) : Colors.black87,
